...
export class PageTransition extends LitElement {
    ...
    makeBegin() {
        return createTimeline({ defaults: { duration: 800 } })
            .set(this.back, {
                left: 0,
                display: 'flex',
                onComplete: () => {
            ...
            .label('here')
            .add(this.poem, { opacity: 1, translateY: ['-2em', 0] }, 'here')
            .add(
                svg.createDrawable(this.lines),
                { draw: ['0 0', '0 1'], ease: 'inOutQuad' },
                'here'
            )
            .add(this.back, { width: ['0%', '100%'] }, 'here');
    }
    ...
    makeEnd() {
        return createTimeline({ defaults: { duration: 800 } })
            ...
            .label('here')
            .add(this.poem, { opacity: 0, translateY: [0, '+2em'] }, 'here')
            .add(this.back, { width: ['100%', '0%'] }, 'here')
