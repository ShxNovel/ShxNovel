...
export class GameBottomTool extends LitElement {
    ...
    isActive(idName) {
        const { name, btn } = this.getBtnByIdName(idName);
...
customElements.define('game-bottom-tool', GameBottomTool);
